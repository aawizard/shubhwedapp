...
import 'package:shubhwed/screens/login_screen.dart';
...
Color textColor = Color(0xFFff5968);

List<String> title = ["Welcome", "Coz Blessings matter", "Hush the Hassle"];
List<String> description = [
  "Your virtual wedding planner-- a one stop solution for all the mayhems of wedding...",
  "Get rid of the Typical wedding gifts...Offering you the entralling opportunity to prepare your wedding giftlist on your own...",
  "Sort out your ,guests, invite them, track down the actual attendies...Productively manage it all !!!",
];
